$(document).ready(function() {
 ...
 $("#cont_producto").css("display", "none");
  ...
  $("#agregar").click(function () {
      var url = "/tienda/producto/_buscar_producto";
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  $.each(data, function(element, fila) {
                      ...
                      tabla += "<td style='display:none;'><input class='form-control centrate' readonly  name='id[]' value='" + fila.producto_id + "'></td>"
                      ...
                      tabla += "<td><input class='form-control centrate'  type='text' name='precio_compra[]' value='" + fila.precio_compra + "'></td>"
                      tabla += "<td><input class='form-control centrate'  type='text' name='precio_venta[]' value='" + fila.precio_venta + "'></td>"
                  });
                  tabla += "</tr>";
...
function compra() {
  alertify.confirm('¿Registrar la Compra?', function(){ $( "#frmcompra" ).submit(); });
}
