        ...
        action: function(a, c, d, b) {
            ...
            if (k.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (f) {
                        c.buttons.info(c.i18n("buttons.copyTitle", "Copiado a portapapeles"), c.i18n("buttons.copySuccess", {
                            1: "copiado una fila en el portapapeles",
                            _: "copio %d filas en portapapeles"
                        }, a.rows), 2E3);
                        return
                    }
                } catch (h) {}
